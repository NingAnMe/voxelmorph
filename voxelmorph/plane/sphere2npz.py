...
if __name__ == '__main__':
    ...
    output_npz = '/mnt/ngshare/PersonData/zhenyu/dataset/SurfReg_parameterization_2D_904'
    ...
    for file in file_names:
        ...
        count += 1
        lh_sphere = os.path.join(input_sphere, file, 'lh.sphere.rigid')
        lh_sulc = os.path.join(input_sphere, file, 'lh.sulc')
        lh_curv = os.path.join(input_sphere, file, 'lh.curv')

        # rh_sphere = os.path.join(input_sphere, file, 'rh.sphere')
        # rh_sulc = os.path.join(input_sphere, file, 'rh.sulc')
        # rh_curv = os.path.join(input_sphere, file, 'rh.curv')
