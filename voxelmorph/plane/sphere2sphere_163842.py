...
from voxelmorph.voxelmorph.sphere.idw import tree

def sphere2sphere_163842(coords_moving, lh_morph_sulc_moving, coords_fixed):
    idw_tree = tree(coords_moving, lh_morph_sulc_moving)
    values_moving_resampled_by_fixed_points_3d = idw_tree(coords_fixed)

    return values_moving_resampled_by_fixed_points_3d
...
if __name__ == '__main__':
    ...
    lh_morph_sulc_moving = nib.freesurfer.read_morph_data(args.sulc_moving)
    coords_fixed, _ = nib.freesurfer.read_geometry(args.sphere_fixed)

    # save the resampled sphere_163842
    values_moving_resampled_by_fixed_points_3d = sphere2sphere_163842(coords_moving, lh_morph_sulc_moving, coords_fixed)
